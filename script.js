...
const audio = {
  ...
  passingTrain: new Audio(
    "assets/audio/passing-train.wav"
  ),
  ...
  atmosphere: new Audio(
    "assets/audio/atmosphere.mp3"
  )
...
function updateAudioVolumes() {
  ...
  /*
    Atmosphere acts as the soft
    background/wind layer.
  */
  ...
  /*
    Passing train and horn are
    automatically kept subtle.
  */

  audio.passingTrain.volume = 0.75;

  audio.horn.volume = 0.55;
...
function startAudio() {
  ...
  /*
    Browser allows audio because
    this function is triggered
    after the ENTER button click.
  */
...
function resumeAudio() {
  ...
  audio.train.play().catch(() => {});

  audio.rain.play().catch(() => {});

  audio.atmosphere.play().catch(() => {});
...
function fadeOutAudio(duration = 3000) {
  ...
  const originalVolumes = sounds.map(
    sound => sound.volume
  );
